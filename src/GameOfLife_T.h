...
void GameOfLife_T<TWidth, THeight>::seed(
...
template <int TWidth, int THeight> void GameOfLife_T<TWidth, THeight>::print() {
...
template <int TWidth, int THeight>
void GameOfLife_T<TWidth, THeight>::setCellsSimultaneously(
    CollectedCells &cellsToChange, int value) {
...
template <int TWidth, int THeight>
void GameOfLife_T<TWidth, THeight>::collectCellsIf(
...
template <int TRows, int TCols> int GameOfLife_T<TRows, TCols>::size() const {
  return m_rows * m_cols;
}

template <int TRows, int TCols> int GameOfLife_T<TRows, TCols>::rows() const {
  return m_rows;
}

template <int TRows, int TCols> int GameOfLife_T<TRows, TCols>::cols() const {
  return m_cols;
}
